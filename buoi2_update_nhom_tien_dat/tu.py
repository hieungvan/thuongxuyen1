...
def main():
    global data
    file_path = 'E:/MA NGUON MO/Tuan 2/New folder/New folder/data.csv'  # Đặt đường dẫn đến file dữ liệu của bạn
    ...
    tk.Button(root, text="Xuất file CSV", command=lambda: export_data(data)).pack(pady=10)
    root.mainloop()
